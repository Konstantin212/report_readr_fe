...
- IBKR Activity CSVs at `C:\Users\Kostan\Downloads\ibkr reports\U13142092_{2023,2024,2025}_*.csv` — multi-section CSV (Statement, Account Info, Trades, Dividends, Interest, Cash Report, Deposits & Withdrawals, Corporate Actions, Mark-to-Market, Realized & Unrealized).
- Freedom Finance JSON at `C:\Users\Kostan\Downloads\201743_..._all.json` — 850 KB with keys `trades.detailed`, `cash_flows.detailed`, `commissions.detailed`, `corporate_actions.detailed`, plus account/period metadata.
