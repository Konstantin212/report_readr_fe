 ...
 *   tests/fixtures/brokers/ibkr-portfolio-2026-06-06/U13142092_*.csv
 */
...
const FILES = [
  "U13142092_2023_2023.csv",
  "U13142092_2024_2024.csv",
  "U13142092_2025_2025.csv",
  "U13142092_20260101_20260605.csv",
];
...
function runPipeline() {
  if (!existsSync(`${FIXTURE_DIR}/${FILES[0]}`)) {
    throw new Error(
      `IBKR fixture missing at ${FIXTURE_DIR}. Drop the four U13142092_*.csv ` +
...
describe("Interactive Brokers real-portfolio parity (U13142092, 2026-06-06)", () => {
  it("parses all four annual statements and produces account U13142092", () => {
    const { accountNumber } = runPipeline();
    expect(accountNumber).toBe("U13142092");
  });
