...
describe("import utilities", () => {
  it("detects supported brokers from common statement file names", () => {
    expect(detectBrokerFromFileName("U00000000_2024_2024.csv")).toBe("INTERACTIVE_BROKERS");
    expect(detectBrokerFromFileName("900000_2024_all.json")).toBe("FREEDOM_FINANCE");
  });
