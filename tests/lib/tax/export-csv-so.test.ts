...
function draft(overrides: Partial<AnlageSoDraft> = {}): AnlageSoDraft {
  return {
    ...
    total: {
      section22: { stakingIncomeEur: 0, eventCount: 0, freigrenzeEur: 256, freigrenzeReached: false, taxableEur: 0 },
      section23: {
        shortTermNetGainEur: 0,
        longTermTaxFreeEur: 0,
        matchCount: 0,
        freigrenzeEur: 1000,
        freigrenzeReached: false,
        taxableEur: 0,
        lossCarryforwardEur: 0,
      },
      totalTaxableEur: 0,
    },
    perCoin: [],
